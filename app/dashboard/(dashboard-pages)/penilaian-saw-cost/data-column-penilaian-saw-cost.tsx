...
import ActionCellPenialainSaw from "@/components/pages/penilaian-saw/action-cell-penilaian-saw";
import { formatCapitalize } from "@/lib/utils";
import { ColumnDef } from "@tanstack/react-table";

export const columnPenilaianSawCost: ColumnDef<PenilaianSAWBenefitProps>[] = [
  {
    id: "No.",
    header: "No",
  ...
  },
  {
    id: "actions",
    cell: ({ row }) => {
      return <ActionCellPenialainSaw type="cost" penilaian={row.original} />;
    },
  },
];
